...
Last edit on May 22 2025 – bumped to v2.4, full script
@author: Galen O'Shea-Stone
"""

import streamlit as st
st.set_page_config(page_title="Streamlit_NMR_Processing_v2.4_cached", layout="wide")
...
selected_norm  = st.multiselect("Normalization", norm_opts,  default=norm_opts[:2])
