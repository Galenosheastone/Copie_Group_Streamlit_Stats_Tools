...
# -*- coding: utf-8 -*-
"""
2_UMAP_Streamlit.py (robust-fix 2025-05-29, v1.6-debug)
Streamlit wrapper for the “UMAP Metabolomics Analysis” pipeline.
Adds debugging shape checks to trace 'Per-column arrays must each be 1-dimensional' errors.
"""
...
# Debug checks for embedding matrices
    ...
    with st.expander("Full SHAP beeswarm"):
        try:
            ...
            try:
                ...
                # Debug: Are any columns array-like?
